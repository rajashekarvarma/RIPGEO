...
######## filter data based p-value (<0.05)

filtered_samples = samples_annotated[samples_annotated['Ttest'] < 0.05]
print('\n','Number of genes remaining after P-value filter of 0.05:',len(filtered_samples)) 
...
# ax.set_xticks(counter)
# ax.set_xticklabels(diff_vals.index.values, rotation=90)
# ax.set_title("Gene expression fold differences of Control vs test")
